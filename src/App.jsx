            ...
            <section id="steps">
              ...
              <ol className="list-decimal ml-6 space-y-4">
                ...
                <li>
                  ...
                  <img src="/instructions-site/public/images/new_repo.PNG" alt="Repository creation picture" />
                </li>
                <li>
                ...
                <li>
                  ...
                  <img src="/instructions-site/public/images/index_create.PNG" />
                </li>
                <li>
...
git push -u origin main`}
                  ...
                  <img src="/instructions-site/public/images/terminal.PNG" />
                </li>
                <li>
                  ...
                  <ul className="list-disc ml-6 mt-2 space-y-1">
                    ...
                    <li>Under "Source", select the branch "main" and click "Save".
                      <img src="/instructions-site/public/images/publish_page.PNG" />
                    </li>
                  </ul>
                </li>
                <li>
